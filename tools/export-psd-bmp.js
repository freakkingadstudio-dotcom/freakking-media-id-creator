...
const sources = [
  ...
  {
    input: "C:/Users/shibi/Downloads/cherithuruthy.psd",
  ...
  {
    input: "C:/Users/shibi/.codex/codex-remote-attachments/019ec137-f294-7b42-b454-a2b77d2b9446/11CD99AF-779E-4703-9B1D-EAA37601CD0E/1-card-1.psd",
    output: path.join(__dirname, "..", "public", "assets", "templates", "template-6.bmp")
  },
  {
    input: "C:/Users/shibi/Downloads/kanjirakode.psd",
    output: path.join(__dirname, "..", "public", "assets", "templates", "template-7.bmp")
  },
  {
    input: "C:/Users/shibi/Downloads/vettikatiri.psd",
    output: path.join(__dirname, "..", "public", "assets", "templates", "template-8.bmp")
  },
  {
    input: "C:/Users/shibi/Downloads/deshamangalam.psd",
    output: path.join(__dirname, "..", "public", "assets", "templates", "template-9.bmp")
  },
  {
    input: "C:/Users/shibi/Downloads/CENTRAL SCHOOL CKRA PSD.psd",
    output: path.join(__dirname, "..", "public", "assets", "templates", "template-10.bmp")
  },
  {
    input: "C:/Users/shibi/Downloads/cresent.psd",
    output: path.join(__dirname, "..", "public", "assets", "templates", "template-11.bmp")
  },
  {
  ...
  {
    input: "C:/Users/shibi/Downloads/thozhupadam.psd",
    output: path.join(__dirname, "..", "public", "assets", "templates", "template-14.bmp")
  },
  {
