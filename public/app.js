...
const templates = {
  ...
  template6: {
    name: "GHSS Panjal",
    image: "/assets/templates/template-6.bmp?v=20260707-panjal-details-down",
    password: "p25",
    options: { bloodGroup: false },
    ...
    fields: {
      ...
      studentClass: { x: 200, y: 714, w: 185, size: pt(7.8), minSize: pt(6.2), weight: 500, color: "#000000", prefix: "Class : " },
      admissionNo: { x: 385, y: 714, w: 185, size: pt(7.8), minSize: pt(6.2), weight: 500, color: "#000000", prefix: "Adm. No : " },
      dob: { x: 200, y: 748, w: 370, size: pt(7.6), minSize: pt(5.8), weight: 500, color: "#000000", prefix: "DOB : " },
